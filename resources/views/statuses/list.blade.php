				...
				<table class="table table-condensed table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a class="btn btn-primary btn-xs" href="{{route('statuses.edit', ['id' => $statuse->id]) }}">Editar</a>
								<a class="btn btn-danger btn-xs" href="{{route('statuses.destroy', ['id' => $statuse->id]) }}">Eliminar</a>
							</td>
